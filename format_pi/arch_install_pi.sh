...
function pacstrapping() {
    ...
    KEYRING_PKG="archlinuxarm-keyring-20140119-2-any.pkg.tar.xz"
    ...
    info "Pacstrapping!3"
    #check_sha1 "68B3537F39A313B3E574D06777193F152BDBE6A6" "/tmp/$KEYRING_PKG" || \
    #check_sha1 "02922214de8981d14dc2acabbc704e86b823cd25" "/tmp/$KEYRING_PKG" || \
